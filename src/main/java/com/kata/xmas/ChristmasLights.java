...
public class ChristmasLights {
    ...
    public static void main(String args[]) {
        ...
        Grid lightGrid = new Grid(1000,1000);
        InstructionManual instructionEngine = new InstructionManual();
        instructionEngine.setInstructions(instructions);
        instructionEngine.setLightGrid(lightGrid);
        Remote remote = new ChristmasLightsRemoteImpl(lightGrid, instructionEngine);
        remote.lumos();
